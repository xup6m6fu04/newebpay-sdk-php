...
trait Trade
{
    ...
    {
        $this->TradeData['Version'] = $version ?? $this->configs['Version'];
    ...
    {
        $this->TradeData['RespondType'] = $type ?? $this->configs['RespondType'];
    ...
    {
        $this->TradeData['LangType'] = $lang ?? $this->configs['LangType'];
    ...
    {
        $this->TradeData['TradeLimit'] = $limit !== null ? $limit : $this->configs['TradeLimit'];
    ...
    {
        $day = $day !== null ? $day : $this->configs['ExpireDate'];
    ...
    {
        $this->TradeData['ReturnURL'] = $url ?? $this->configs['ReturnURL'];
    ...
    {
        $this->TradeData['NotifyURL'] = $url ?? $this->configs['NotifyURL'];
    ...
    {
        $this->TradeData['CustomerURL'] = $url ?? $this->configs['CustomerURL'];
    ...
    {
        $this->TradeData['ClientBackURL'] = $url ?? $this->configs['ClientBackURL'];
    ...
    {
        $this->TradeData['EmailModify'] = ($isModify !== null ? $isModify : $this->configs['EmailModify']) ? 1 : 0;
    ...
    {
        $this->TradeData['LoginType'] = ($isLogin !== null ? $isLogin : $this->configs['LoginType']) ? 1 : 0;
    ...
    {
        $this->TradeData['OrderComment'] = $comment !== null ? $comment : $this->configs['OrderComment'];
    ...
    {
        $paymentMethod = array_merge($this->configs['PaymentMethod'], $paymentMethod);
    ...
    {
        $this->TradeData['CVSCOM'] = $cvscom !== null ? $cvscom : $this->configs['CVSCOM'];
    ...
    {
        $this->TradeData['LgsType'] = $lgsType !== null ? $lgsType : $this->configs['LgsType'];
